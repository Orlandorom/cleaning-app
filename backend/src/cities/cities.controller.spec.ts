...
describe('CitiesController', () => {
  ...
  describe('findAll', () => {
    it('should call service.findAll without query', async () => {
      const expected = [{ id: '1', name: 'Bogotá', createdAt: new Date() }];
  ...
  describe('update', () => {
    it('should call service.update with id and dto', async () => {
      const dto: UpdateCityDto = { name: 'Bogotá D.C.' };
      const expected = { id: '1', name: 'Bogotá D.C.', createdAt: new Date() };
